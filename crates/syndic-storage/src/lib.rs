...
pub use mutation::{
    ...
    FirstAcceptance, FirstAcceptanceKind, FirstAcceptanceStatus, FreezeNextTurnItem, JoinStopCause,
    LiveSourceEvent, LiveSourceEventStatus, PROVIDER_FRAME_STAGE_MAX_NARRATIVE_SPANS,
    PreparedProviderFrame, PromoteAcceptedInput, ProviderCompletionComparisonMutationError,
    ProviderFrameMutationError, ProviderFramePreparationError, ProviderFramePreparationPlan,
