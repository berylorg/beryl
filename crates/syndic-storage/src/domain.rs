...
const V2_FAMILIES: &[RecordFamily<SyndicDomain>] = &[
    ...
    RecordFamily::new::<InputMarkerResolutionsCodec>(KeyspaceSchemaVersion::new(1)),
    ...
    RecordFamily::new::<AcceptedSteeringCodec>(KeyspaceSchemaVersion::new(1)),
    RecordFamily::new::<AcceptedNextCodec>(KeyspaceSchemaVersion::new(1)),
...
impl StorageDomain for SyndicDomain {
    ...
    const FAMILIES: &'static [RecordFamily<Self>] = V2_FAMILIES;
...
/// Opaque typed access to the permanent Syndic V2 domain in one Beryl home.
#[derive(Clone, Copy)]
...
impl SyndicStorage {
    /// Registers the exact V2 domain and validates every persisted family before publication.
