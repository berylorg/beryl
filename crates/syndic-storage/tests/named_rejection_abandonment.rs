...
#[path = "named_rejection_abandonment/generic_witness_corruption.rs"]
...
fn named_rejection_abandonment_fault_cuts_reconcile_old_or_exact() {
    for (name, point, expected) in [
        (
            "named-abandon-before-commit",
            FaultPoint::BeforeCommit,
            BindingPublicationStatus::Prior,
        ),
        (
            "named-abandon-after-commit",
            FaultPoint::AfterCommitBeforePersist,
            BindingPublicationStatus::Exact,
        ),
        (
            "named-abandon-after-persist",
...
fn generic_abandonment_fault_cuts_reconcile_old_or_exact() {
    for (name, point, expected) in [
        (
            "generic-abandon-before-commit",
            FaultPoint::BeforeCommit,
            BindingPublicationStatus::Prior,
        ),
        (
            "generic-abandon-after-commit",
            FaultPoint::AfterCommitBeforePersist,
            BindingPublicationStatus::Exact,
        ),
        (
            "generic-abandon-after-persist",
            FaultPoint::AfterPersist,
            BindingPublicationStatus::Exact,
        ),
    ] {
