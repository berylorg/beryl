...
#[path = "activity_query_corruption/support.rs"]
...
fn publication_rejects_a_final_answer_with_later_activity_before_terminal() {
    let candidate = child_handoff_candidate("activity-nonadjacent-handoff", true);
...
#[test]
fn scrub_rejects_handoff_entry_fact_that_disagrees_with_membership() {
    let fixture = published_child_handoff("activity-handoff-fact-corruption");
