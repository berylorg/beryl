...
fn stopping_gate_without_its_selected_record_is_rejected() {
    let fixture = active_stop_fixture("stop-missing-record");
    fixture.admit_stop();
...
fn reconciliation_rejects_a_missing_selected_route_head_half() {
    let fixture = active_stop_fixture("stop-missing-route-head");
    fixture.admit_stop();
    delete(
        &fixture,
...
fn safe_reopen_reconciliation_rejects_a_missing_successor_route_half() {
    let fixture = active_stop_fixture("stop-missing-reopen-route");
    fixture.admit_stop();
...
fn matching_terminal_reconciliation_rejects_a_missing_event_half() {
    let fixture = active_stop_fixture("stop-missing-terminal-event");
    fixture.admit_stop();
    correlate_user_item(
        &fixture.store,
        &fixture.storage,
...
fn admission_reconciliation_rejects_a_missing_immutable_cas_target_half() {
    let fixture = active_stop_fixture("stop-missing-cas-turn");
    fixture.admit_stop();
    delete(
        &fixture,
...
fn unselected_live_stop_record_is_rejected() {
    let fixture = active_stop_fixture("stop-orphan-record");
    fixture.admit_stop();
