...
use syndic_storage::provider_frame_test_support::decode_bounded_provider_item_frame_v1;
use syndic_storage::*;
...
#[path = "provider_codec/content_reference.rs"]
mod content_reference;
#[path = "provider_codec/validation.rs"]
mod validation;
