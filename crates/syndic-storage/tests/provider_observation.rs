...
#[path = "provider_observation/depth.rs"]
mod depth;
#[path = "provider_observation/identity.rs"]
mod identity;
#[path = "provider_observation/identity_exclusions.rs"]
mod identity_exclusions;
#[path = "provider_observation/lifecycle.rs"]
mod lifecycle;
#[path = "provider_observation/matrix.rs"]
mod matrix;
#[path = "provider_observation/matrix_restart.rs"]
mod matrix_restart;
#[path = "provider_observation/nested.rs"]
mod nested;
#[path = "provider_observation/reasoning_privacy.rs"]
mod reasoning_privacy;
#[path = "provider_observation/restart_validation.rs"]
mod restart_validation;
#[path = "provider_observation/schemas.rs"]
mod schemas;
mod support;
#[path = "provider_observation/validation.rs"]
mod validation;
