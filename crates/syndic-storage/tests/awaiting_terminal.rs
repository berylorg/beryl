...
#[cfg(feature = "test-faults")]
#[path = "awaiting_terminal/canonical.rs"]
mod canonical;
#[cfg(feature = "test-faults")]
#[path = "awaiting_terminal/corruption.rs"]
mod corruption;
#[cfg(feature = "test-faults")]
#[path = "awaiting_terminal/recovery.rs"]
mod recovery;
#[cfg(feature = "test-faults")]
#[path = "awaiting_terminal/resolution.rs"]
mod resolution;
...
fn unknown_terminal_without_queued_input_reactivates_the_exact_target() {
    let fixture = active_fixture("awaiting-terminal-default-reactivation");
...
fn late_terminal_without_queued_input_enters_and_releases_terminal_history() {
    let fixture = active_fixture("awaiting-terminal-default-resolution");
    admit_unknown(&fixture, 6);
    admit_event(
        &fixture.store,
        &fixture.storage,
...
fn restart_classifies_empty_awaiting_terminal_as_active_loss_authority() {
    let fixture = active_fixture("awaiting-terminal-default-recovery");
    admit_unknown(&fixture, 6);
    let ActiveFixture {
        _home: home,
        store,
...
fn uncertain_terminal_reclassifies_ready_work_and_reactivation_uses_a_fresh_route() {
    let fixture = active_fixture("awaiting-terminal-reactivation");
