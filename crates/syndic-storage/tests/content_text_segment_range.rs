...
#[path = "content_text_segment_range/corruption.rs"]
mod corruption;
...
fn exact_page_boundaries_have_one_absolute_continuation() {
    ...
    let fixture = seed(
        "content-segments-page-boundary",
...
fn cursor_offsets_limits_references_and_absence_are_typed() {
    ...
    let fixture = seed("content-segments-invalid", &source);
    let leading = prove(&fixture, None);
    let first_piece_donor = seed(
        "content-segments-invalid-first-donor",
    ...
    let fourth_piece_donor = seed(
        "content-segments-invalid-fourth-donor",
...
fn proof_is_complete_before_terminal_or_valid_prefix_pages_are_authorized() {
    ...
    let fixture = seed(
        "content-segments-proof-before-pages",
