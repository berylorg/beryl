...
#[path = "accepted_promotion/descendants.rs"]
mod descendants;
#[path = "accepted_promotion/newer_generation.rs"]
mod newer_generation;
#[path = "accepted_promotion/prior_delivery_witness.rs"]
...
fn stale_candidate_and_fresh_identity_collision_do_not_partially_promote() {
    let (_home, store, storage, _fixture) =
        seeded_fixture("promote-races", promotion_fixture(91, id(91)));
