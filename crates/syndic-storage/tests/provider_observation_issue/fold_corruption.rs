...
fn validation_rejects_a_missing_folded_issue_fact() {
    let fixture = setup("provider-observation-issue-missing-fold");
...
fn validation_rejects_a_wrong_folded_issue_fact() {
    let fixture = setup("provider-observation-issue-wrong-fold");
...
fn terminal_state_must_retain_its_folded_issue_fact() {
    let fixture = setup("provider-observation-issue-terminal-fold");
