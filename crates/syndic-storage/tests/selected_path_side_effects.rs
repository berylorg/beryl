...
#[path = "selected_path_side_effects/fixture.rs"]
mod fixture;
#[path = "selected_path_side_effects/helpers.rs"]
mod helpers;
#[path = "selected_path_side_effects/off_path.rs"]
mod off_path;
#[path = "selected_path_side_effects/selected_path.rs"]
mod selected_path;
