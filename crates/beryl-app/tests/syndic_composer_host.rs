...
#[path = "syndic_composer_host/activation_replay.rs"]
mod activation_replay;
#[path = "syndic_composer_host/range_custody.rs"]
mod range_custody;
#[cfg(feature = "test-faults")]
#[path = "syndic_composer_host/read_drift.rs"]
mod read_drift;
#[path = "syndic_composer_host/stale_completion.rs"]
mod stale_completion;
#[cfg(feature = "test-faults")]
#[path = "syndic_composer_host/typed_failures.rs"]
mod typed_failures;
