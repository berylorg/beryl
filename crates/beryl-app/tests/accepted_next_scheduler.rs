...
mod conflicts;
#[path = "accepted_next_scheduler/process_admission.rs"]
...
fn turn_start_reserve_denials_park_queued_candidate_without_dispatch() {
    for (seed, observation) in [
        ...
        let parent = fixture.submit_text(" queued reserve parent");
        fixture.complete_with_assistant(parent, " queued reserve answer");
        let storage = fixture.storage.clone();
...
fn queued_turn_start_threshold_requires_the_same_composed_total() {
    ...
    let parent = fixture.submit_text(" queued threshold parent");
    fixture.complete_with_assistant(parent, " queued threshold answer");
    let storage = fixture.storage.clone();
    let thread_id = fixture.thread;
    let execution = syndic::execution_binding();
    let server = NormalTerminalServer::spawn_admission_only_controlled_close();
...
fn connection_retirement_cannot_overtake_reserved_promotion() {
    ...
    let parent = fixture.submit_text(" retirement parent");
    fixture.complete_with_assistant(parent, " retirement answer");
    let storage = fixture.storage.clone();
    let thread_id = fixture.thread;
    let execution = syndic::execution_binding();
...
fn connection_retirement_before_reservation_leaves_the_candidate_queued() {
    ...
    let parent = fixture.submit_text(" retirement-first parent");
    fixture.complete_with_assistant(parent, " retirement-first answer");
    let storage = fixture.storage.clone();
    let thread_id = fixture.thread;
    let execution = syndic::execution_binding();
    let server = NormalTerminalServer::spawn_admission_only();
