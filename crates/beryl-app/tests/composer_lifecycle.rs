...
#[path = "composer_lifecycle/admission.rs"]
mod lifecycle_admission;
#[path = "composer_lifecycle/common.rs"]
mod lifecycle_common;
#[path = "composer_lifecycle/edges.rs"]
mod lifecycle_edges;
#[path = "composer_lifecycle/failures.rs"]
mod lifecycle_failures;
#[path = "composer_lifecycle/marker_noncommit.rs"]
mod lifecycle_marker_noncommit;
#[path = "composer_lifecycle/reconciliation.rs"]
