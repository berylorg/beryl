...
pub(crate) const COMPOSER_INPUT_PADDING_X: f32 = 12.0;
pub(crate) const COMPOSER_INPUT_PADDING_TOP: f32 = 4.0;
pub(crate) const COMPOSER_INPUT_PADDING_BOTTOM: f32 = 8.0;
pub(crate) const COMPOSER_INPUT_BORDER_WIDTH: f32 = 1.0;
pub(crate) const COMPOSER_INPUT_VERTICAL_CHROME: f32 =
    COMPOSER_INPUT_PADDING_TOP + COMPOSER_INPUT_PADDING_BOTTOM + COMPOSER_INPUT_BORDER_WIDTH * 2.0;
