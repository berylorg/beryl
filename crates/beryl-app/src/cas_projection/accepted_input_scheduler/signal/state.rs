...
pub struct AcceptedInputSchedulerDiagnostics {
    ...
    pub(in super::super) verification_pauses: u64,
    pub(in super::super) steering_pass_count: u64,
    pub(in super::super) recovered_pending_pass_count: u64,
    pub(in super::super) recovered_projection_pass_count: u64,
    ...
    pub(in super::super) recovered_projection_flight_waits: u64,
    pub(in super::super) next_flight_waits: u64,
    pub(in super::super) recovered_pending_execution_unavailable: u64,
    pub(in super::super) recovered_projection_execution_unavailable: u64,
    pub(in super::super) recovered_projection_staged: u64,
    pub(in super::super) recovered_projection_retained: usize,
    pub(in super::super) recovered_projection_high_water: usize,
    pub(in super::super) recovered_projection_requeues: u64,
