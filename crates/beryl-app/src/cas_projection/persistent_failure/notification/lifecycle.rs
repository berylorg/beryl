...
impl PersistentFailureNotification {
    ...
    #[cfg(all(test, feature = "test-faults"))]
    pub(in crate::cas_projection::persistent_failure) fn install_verification_join_observation_hook(
        &self,
        ticket: &Arc<VerificationCompletionCell>,
    ...
    pub(in crate::cas_projection::persistent_failure) fn verification_completion_ticket(
        &self,
        home: &HomeStore,
        home_id: BerylHomeId,
    ...
    pub(in crate::cas_projection::persistent_failure) fn register_verification_join(
        &self,
        home: &HomeStore,
        home_id: BerylHomeId,
        home_generation: HomeGeneration,
    ...
    pub(in crate::cas_projection::persistent_failure) fn wait_for_verification_completion(
        &self,
    ...
    #[cfg(test)]
    pub(super) fn finish_recovery_supervisor_flight(&self, requeue_unhealthy: bool) {
