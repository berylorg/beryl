...
pub(super) fn canonicalize_connections(
...
pub(super) fn same_connection_set(
...
pub(super) fn preflight_candidates(
...
pub(super) fn validate_candidate_projection(
    identity: PersistentFailureCutIdentity,
    connections: &[Arc<ProjectionConnection>],
...
pub(super) fn projection_witness(projection: &LoadedCasProjection) -> PendingProjectionWitness {
...
pub(super) fn preflight_target_results(
    identity: PersistentFailureCutIdentity,
    connections: &[Arc<ProjectionConnection>],
...
pub(super) fn target_result_matches_guard(
...
pub(super) fn preflight_target_projections(
    identity: PersistentFailureCutIdentity,
    connections: &[Arc<ProjectionConnection>],
    drain: &PersistentFailureRecoveryDrain,
    expected_registry: &mut Vec<LoadedRegistryRecoveryObservation>,
...
pub(super) fn is_exact_target_observation(
    identity: PersistentFailureCutIdentity,
    observation: &LoadedLeaseRecoveryObservation,
) -> bool {
...
pub(super) fn preflight_reacquisition_anchors(
    identity: PersistentFailureCutIdentity,
    connections: &[Arc<ProjectionConnection>],
...
pub(super) fn preflight_raw_registry_owners(
    identity: PersistentFailureCutIdentity,
    connections: &[Arc<ProjectionConnection>],
    drain: &PersistentFailureRecoveryDrain,
    expected_registry: &mut Vec<LoadedRegistryRecoveryObservation>,
...
pub(super) fn preflight_connection_barriers(
    identity: PersistentFailureCutIdentity,
    connections: &[Arc<ProjectionConnection>],
    drain: &PersistentFailureRecoveryDrain,
) -> Result<(), PersistentFailurePendingProjectionQuarantineReason> {
...
pub(super) fn preflight_promotion_barrier(
    identity: PersistentFailureCutIdentity,
    connections: &[Arc<ProjectionConnection>],
...
pub(super) fn preflight_cleanup_barrier(
    identity: PersistentFailureCutIdentity,
    connections: &[Arc<ProjectionConnection>],
...
pub(super) fn matching_stable_connection<'a>(
...
pub(super) fn connection_for_identity(
    connections: &[Arc<ProjectionConnection>],
...
pub(super) fn validate_registry_scope(
...
pub(in crate::cas_projection::persistent_failure::quarantine::conversion) fn unique_registry_observations(
    observations: &[LoadedRegistryRecoveryObservation],
) -> Result<
...
pub(in crate::cas_projection::persistent_failure::quarantine::conversion) fn audit_error_reason(
