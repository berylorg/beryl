...
Pointer-wheel, touchpad, touch, keyboard, and programmatic scrolling act on the routed scrollable viewport. Thumb dragging and lane clicks originate from scrollbar chrome and route through the owning scroll container's callbacks.
