...
- While parent assistant narrative commentary is arriving and the user has not manually scrolled, Beryl may follow commentary only as needed to keep newly arriving commentary visible at the bottom of the viewport. Commentary following preserves the current semantic follow target rather than repeatedly bottom-aligning the whole turn.
