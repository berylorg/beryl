...
The feature supplies at most one active bounded notice record from its FIFO queue, including stable
notice identity, content revision, bounded title and detail projections, variant, and exact
dismissal effect. Queue caps, deduplication, coalescing, ordering, and the decision to advance after
dismissal remain in `design.md`; queued records are not mounted behind the visible widget.
