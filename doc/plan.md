...
# Phase 172: Provide The Live Main-Window Composer Slot (pending)
...
# Phase 173: Mount Conversation Composer And Editable Image Markers (pending)
...
# Phase 174: Enforce And Accept Bounded Composer Integration At Large Scale (pending)
...
# Phase 175: Mount Native-Lineage Recovery And Editor Restoration (pending)
...
# Phase 176: Build The Multi-Window Shell And Runtime Bootstrap (pending)
...
# Phase 177: Mount Paged Navigation And Settings (pending)
...
# Phase 178: Mount Main-Window Notices (pending)
...
# Phase 179: Implement Notification Audio Ownership (pending)
...
# Phase 180: Mount Transcript Presentation (pending)
...
# Phase 181: Verify And Close The Useful GUI Checkpoint (pending)
...
# Phase 182: Prove The Exact 0.146.0 Terminal-Repair Surface (pending)
...
# Phase 183: Implement The Private Terminal-Repair Adapter (pending)

Implement the private release-pinned adapter proven by Phase 182: one no-successor-gated
...
# Phase 184: Add Snapshot-Specific Syndic Repair Storage (pending)
...
# Phase 185: Enforce Repair-Required Successor Gates (pending)
...
# Phase 186: Claim Terminal Repair Durably (pending)
...
consumption and backend dispatch unmounted until Phase 196 installs cross-domain repair-media
...
# Phase 187: Integrate Atomic Terminal-Turn Repair (pending)
...
no-successor proof and durable Phase 186 claim, then converges to exactly repaired or explicitly
...
# Phase 188: Add Bounded Outage Capture (pending)
...
# Phase 189: Publish Entirely Fresh Same-Home Recovery (pending)
...
# Phase 190: Verify And Close The Repair And Recovery Checkpoint (pending)
...
gap remains fail-closed: no target dispatches and no durable claim is consumed before Phase 196.

# Phase 191: Implement Branch Discussion Creation (pending)
...
# Phase 192: Implement Resolution Handoff (pending)
...
# Phase 193: Verify And Close Checkpoint 6 (pending)
...
# Phase 194: Implement Asset Admission And Durable Ownership (pending)
...
# Phase 195: Implement Media Rendition Resources (pending)
...
# Phase 196: Implement Generated-Image Repair Media (pending)
...
retain inline base64. After this admission path is installed, mount the Phase 186 claim-consumption
and Phase 187 repair-dispatch path for all eligible targets. Prove crash cuts, collision, orphan
invisibility, coherent publication, and no pre-admission claim consumption.

# Phase 197: Mount Maintenance Presentation And Deferred Cleanup (pending)
...
# Phase 198: Verify And Close Checkpoint 7 (pending)
...
# Phase 199: Reconcile Final Live Authority (pending)
...
# Phase 200: Remove Obsolete Surfaces (pending)
...
# Phase 201: Verify Named Resource Boundaries (pending)
...
# Phase 202: Run End-To-End Functional Verification (pending)
...
# Phase 203: Close The Rework (pending)
