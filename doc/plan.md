...
# Phase 175: Provide The Live Main-Window Composer Slot (pending)
...
# Phase 176: Mount Conversation Composer And Editable Image Markers (pending)
...
# Phase 177: Enforce And Accept Bounded Composer Integration At Large Scale (pending)
...
# Phase 178: Mount Native-Lineage Recovery And Editor Restoration (pending)
...
# Phase 179: Build The Multi-Window Shell And Runtime Bootstrap (pending)
...
# Phase 180: Mount Paged Navigation And Settings (pending)
...
# Phase 181: Mount Main-Window Notices (pending)
...
# Phase 182: Implement Notification Audio Ownership (pending)
...
# Phase 183: Mount Transcript Presentation (pending)
...
# Phase 184: Verify And Close The Useful GUI Checkpoint (pending)
...
# Phase 185: Prove The Exact 0.146.0 Terminal-Repair Surface (pending)
...
# Phase 186: Implement The Private Terminal-Repair Adapter (pending)

Implement the private release-pinned adapter proven by Phase 185: one no-successor-gated
...
# Phase 187: Add Snapshot-Specific Syndic Repair Storage (pending)
...
# Phase 188: Enforce Repair-Required Successor Gates (pending)
...
# Phase 189: Claim Terminal Repair Durably (pending)
...
consumption and backend dispatch unmounted until Phase 199 installs cross-domain repair-media
...
# Phase 190: Integrate Atomic Terminal-Turn Repair (pending)
...
no-successor proof and durable Phase 189 claim, then converges to exactly repaired or explicitly
...
# Phase 191: Add Bounded Outage Capture (pending)
...
# Phase 192: Publish Entirely Fresh Same-Home Recovery (pending)
...
# Phase 193: Verify And Close The Repair And Recovery Checkpoint (pending)
...
gap remains fail-closed: no target dispatches and no durable claim is consumed before Phase 199.

# Phase 194: Implement Branch Discussion Creation (pending)
...
# Phase 195: Implement Resolution Handoff (pending)
...
# Phase 196: Verify And Close Checkpoint 6 (pending)
...
# Phase 197: Implement Asset Admission And Durable Ownership (pending)
...
# Phase 198: Implement Media Rendition Resources (pending)
...
# Phase 199: Implement Generated-Image Repair Media (pending)
...
retain inline base64. After this admission path is installed, mount the Phase 189 claim-consumption
and Phase 190 repair-dispatch path for all eligible targets. Prove crash cuts, collision, orphan
invisibility, coherent publication, and no pre-admission claim consumption.

# Phase 200: Mount Maintenance Presentation And Deferred Cleanup (pending)
...
# Phase 201: Verify And Close Checkpoint 7 (pending)
...
# Phase 202: Reconcile Final Live Authority (pending)
...
# Phase 203: Remove Obsolete Surfaces (pending)
...
# Phase 204: Verify Named Resource Boundaries (pending)
...
# Phase 205: Run End-To-End Functional Verification (pending)
...
# Phase 206: Close The Rework (pending)
