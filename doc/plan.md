...
# Phase 272: Requalify The Complete GPUI Text Input Focused Gate (pending)
...
# Phase 273: Publish GPUI Text Input After Its Focused Gate Passes (pending)
...
# Phase 274: Propagate The GPUI Revision Through GPUI Settings Window (pending)
...
# Phase 275: Canonically Pin The Unified GPUI Dependency Chain In Beryl (pending)
...
# Phase 276: Build The Target-State Main-Window Shell Foundation (pending)
...
# Phase 277: Mount Bounded Independent Main-Window Creation (pending)

Mount `New Window` and `Ctrl+Shift+N` through the invoking controller's exact runtime/root, the
process registry, Phase 236 acquisition, Phase 275 hidden host, and exact publication or
