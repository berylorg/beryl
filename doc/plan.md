...
Add the fixed-capacity compact undo/redo frontier over immutable historical roots and exact ranges.
Stream inverse content from authenticated roots through the same candidate edit path, clear redo
only after a newly adopted ordinary edit, and retain no draft-sized inverse text or marker registry.

# Phase 145: Publish Dirty Candidates And Satisfy Flush Barriers (pending)
...
# Phase 146: Materialize Exact Draft Roots For Submission (pending)
...
# Phase 147: Provide The Live Main-Window Composer Slot (pending)
...
# Phase 148: Mount Conversation Composer And Editable Image Markers (pending)
...
# Phase 149: Accept Bounded Composer Integration At Large Scale (pending)
...
# Phase 150: Mount Native-Lineage Recovery And Editor Restoration (pending)
...
# Phase 151: Build The Multi-Window Shell And Runtime Bootstrap (pending)
...
# Phase 152: Mount Paged Navigation And Settings (pending)
...
# Phase 153: Mount Main-Window Notices (pending)
...
# Phase 154: Implement Notification Audio Ownership (pending)
...
# Phase 155: Mount Transcript Presentation (pending)
...
# Phase 156: Verify And Close The Useful GUI Checkpoint (pending)
...
# Phase 157: Prove The Exact 0.146.0 Terminal-Repair Surface (pending)
...
# Phase 158: Implement The Private Terminal-Repair Adapter (pending)

Implement the private release-pinned adapter proven by Phase 157: one no-successor-gated
...
# Phase 159: Add Snapshot-Specific Syndic Repair Storage (pending)
...
# Phase 160: Enforce Repair-Required Successor Gates (pending)
...
# Phase 161: Claim Terminal Repair Durably (pending)
...
consumption and backend dispatch unmounted until Phase 171 installs cross-domain repair-media
...
# Phase 162: Integrate Atomic Terminal-Turn Repair (pending)
...
no-successor proof and durable Phase 161 claim, then converges to exactly repaired or explicitly
...
# Phase 163: Add Bounded Outage Capture (pending)
...
# Phase 164: Publish Entirely Fresh Same-Home Recovery (pending)
...
# Phase 165: Verify And Close The Repair And Recovery Checkpoint (pending)
...
gap remains fail-closed: no target dispatches and no durable claim is consumed before Phase 171.

# Phase 166: Implement Branch Discussion Creation (pending)
...
# Phase 167: Implement Resolution Handoff (pending)
...
# Phase 168: Verify And Close Checkpoint 6 (pending)
...
# Phase 169: Implement Asset Admission And Durable Ownership (pending)
...
# Phase 170: Implement Media Rendition Resources (pending)
...
# Phase 171: Implement Generated-Image Repair Media (pending)
...
retain inline base64. After this admission path is installed, mount the Phase 161 claim-consumption
and Phase 162 repair-dispatch path for all eligible targets. Prove crash cuts, collision, orphan
invisibility, coherent publication, and no pre-admission claim consumption.

# Phase 172: Mount Maintenance Presentation And Deferred Cleanup (pending)
...
# Phase 173: Verify And Close Checkpoint 7 (pending)
...
# Phase 174: Reconcile Final Live Authority (pending)
...
# Phase 175: Remove Obsolete Surfaces (pending)
...
# Phase 176: Verify Named Resource Boundaries (pending)
...
# Phase 177: Run End-To-End Functional Verification (pending)
...
# Phase 178: Close The Rework (pending)
