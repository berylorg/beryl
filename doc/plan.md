...
# Phase 157: Route Host Undo And Redo Through Durable Root History (pending)
...
# Phase 158: Enforce Credit-Gated Composer Realization (pending)
...
# Phase 159: Publish Dirty Candidates And Satisfy Flush Barriers (pending)
...
# Phase 160: Materialize Exact Draft Roots For Submission (pending)
...
# Phase 161: Provide The Live Main-Window Composer Slot (pending)
...
# Phase 162: Mount Conversation Composer And Editable Image Markers (pending)
...
# Phase 163: Accept Bounded Composer Integration At Large Scale (pending)
...
# Phase 164: Mount Native-Lineage Recovery And Editor Restoration (pending)
...
# Phase 165: Build The Multi-Window Shell And Runtime Bootstrap (pending)
...
# Phase 166: Mount Paged Navigation And Settings (pending)
...
# Phase 167: Mount Main-Window Notices (pending)
...
# Phase 168: Implement Notification Audio Ownership (pending)
...
# Phase 169: Mount Transcript Presentation (pending)
...
# Phase 170: Verify And Close The Useful GUI Checkpoint (pending)
...
# Phase 171: Prove The Exact 0.146.0 Terminal-Repair Surface (pending)
...
# Phase 172: Implement The Private Terminal-Repair Adapter (pending)

Implement the private release-pinned adapter proven by Phase 171: one no-successor-gated
...
# Phase 173: Add Snapshot-Specific Syndic Repair Storage (pending)
...
# Phase 174: Enforce Repair-Required Successor Gates (pending)
...
# Phase 175: Claim Terminal Repair Durably (pending)
...
consumption and backend dispatch unmounted until Phase 185 installs cross-domain repair-media
...
# Phase 176: Integrate Atomic Terminal-Turn Repair (pending)
...
no-successor proof and durable Phase 175 claim, then converges to exactly repaired or explicitly
...
# Phase 177: Add Bounded Outage Capture (pending)
...
# Phase 178: Publish Entirely Fresh Same-Home Recovery (pending)
...
# Phase 179: Verify And Close The Repair And Recovery Checkpoint (pending)
...
gap remains fail-closed: no target dispatches and no durable claim is consumed before Phase 185.

# Phase 180: Implement Branch Discussion Creation (pending)
...
# Phase 181: Implement Resolution Handoff (pending)
...
# Phase 182: Verify And Close Checkpoint 6 (pending)
...
# Phase 183: Implement Asset Admission And Durable Ownership (pending)
...
# Phase 184: Implement Media Rendition Resources (pending)
...
# Phase 185: Implement Generated-Image Repair Media (pending)
...
retain inline base64. After this admission path is installed, mount the Phase 175 claim-consumption
and Phase 176 repair-dispatch path for all eligible targets. Prove crash cuts, collision, orphan
invisibility, coherent publication, and no pre-admission claim consumption.

# Phase 186: Mount Maintenance Presentation And Deferred Cleanup (pending)
...
# Phase 187: Verify And Close Checkpoint 7 (pending)
...
# Phase 188: Reconcile Final Live Authority (pending)
...
# Phase 189: Remove Obsolete Surfaces (pending)
...
# Phase 190: Verify Named Resource Boundaries (pending)
...
# Phase 191: Run End-To-End Functional Verification (pending)
...
# Phase 192: Close The Rework (pending)
