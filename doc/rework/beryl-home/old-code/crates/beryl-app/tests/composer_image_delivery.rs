...
#[test]
fn wsl_runtime_maps_drive_asset_path_to_mount_path_and_validates_host_path() {
    ...
    assert_eq!(
        ...
        r"C:\Users\user\.beryl\workspaces\ws\image-assets\img.png"
    );
    assert_eq!(probed, vec![host_path]);
}
