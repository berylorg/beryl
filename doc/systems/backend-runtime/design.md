...
- CAS historical turn reads through `thread/turns/list` are legacy or transitional compatibility only. They must not be required as the selected transcript rendering source after the CAS-live Syndic capture cutover.
