...
- The then-authoritative UI docs were updated to reflect this panel-level vertical scroll contract.
...
- `doc/features/semantic-graph/design.md` now reflects this per-column vertical scroll contract.
