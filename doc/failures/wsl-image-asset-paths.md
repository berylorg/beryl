...
- Affected docs/tests at the time: `doc/features/workspaces/design.md`, `doc/features/composer/design.md`, the former aggregate app-server contract notes, and `crates/beryl-app/tests/composer_image_delivery.rs`.
